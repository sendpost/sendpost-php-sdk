...
**created_by** | [**\sendpost\model\Member**](.md) | Member who created the sub-account | [optional]
**updated_by** | [**\sendpost\model\Member**](.md) | Member who updated the sub-account | [optional]
