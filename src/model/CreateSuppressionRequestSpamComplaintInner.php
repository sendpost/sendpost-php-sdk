...
/**
 * CreateSuppressionRequestSpamComplaintInner Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class CreateSuppressionRequestSpamComplaintInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSuppression_request_spamComplaint_inner';
