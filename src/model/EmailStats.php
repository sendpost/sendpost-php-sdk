 ...
 */
class EmailStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailStats';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'stats' => '\sendpost\model\EmailStatsStats'
    ];
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The UTC date for which stats are retrieved
     *
     * @return self
     */
     ...
     * Gets stats
     *
     * @return \sendpost\model\EmailStatsStats|null
     */
     ...
     * Sets stats
     *
     * @param \sendpost\model\EmailStatsStats|null $stats stats
     *
     * @return self
     */
