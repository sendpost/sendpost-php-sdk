...
/**
 * IPDeletionResponse Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class IPDeletionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPDeletionResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The unique ID of the IP
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message The confirmation message after deletion
     *
     * @return self
     */
