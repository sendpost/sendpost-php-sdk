...
class CreateSuppressionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSuppression_request';
    ...
    protected static $openAPITypes = [
        'hard_bounce' => '\sendpost\model\CreateSuppressionRequestHardBounceInner[]',
        'manual' => '\sendpost\model\CreateSuppressionRequestManualInner[]',
        'unsubscribe' => '\sendpost\model\CreateSuppressionRequestUnsubscribeInner[]',
        'spam_complaint' => '\sendpost\model\CreateSuppressionRequestSpamComplaintInner[]'
    ];
    ...
    */
     ...
     * Gets hard_bounce
     *
     * @return \sendpost\model\CreateSuppressionRequestHardBounceInner[]|null
     */
     ...
     * Sets hard_bounce
     *
     * @param \sendpost\model\CreateSuppressionRequestHardBounceInner[]|null $hard_bounce list of email addresses which you want to mark in hardBounce suppression list
     *
     * @return self
     */
     ...
     * Gets manual
     *
     * @return \sendpost\model\CreateSuppressionRequestManualInner[]|null
     */
     ...
     * Sets manual
     *
     * @param \sendpost\model\CreateSuppressionRequestManualInner[]|null $manual list of email addresses which you want to mark in manual suppression list
     *
     * @return self
     */
     ...
     * Gets unsubscribe
     *
     * @return \sendpost\model\CreateSuppressionRequestUnsubscribeInner[]|null
     */
     ...
     * Sets unsubscribe
     *
     * @param \sendpost\model\CreateSuppressionRequestUnsubscribeInner[]|null $unsubscribe list of email addresses which you want to mark in unsubscribe suppression list
     *
     * @return self
     */
     ...
     * Gets spam_complaint
     *
     * @return \sendpost\model\CreateSuppressionRequestSpamComplaintInner[]|null
     */
     ...
     * Sets spam_complaint
     *
     * @param \sendpost\model\CreateSuppressionRequestSpamComplaintInner[]|null $spam_complaint list of email addresses which you want to mark in spamComplaint suppression list
     *
     * @return self
     */
