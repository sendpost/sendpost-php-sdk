...
/**
 * EmailStatsStats Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class EmailStatsStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailStats_stats';
    ...
    */
     ...
     * Sets delivered
     *
     * @param int|null $delivered Number of emails successfully delivered to SMTP without errors
     *
     * @return self
     */
     ...
     * Sets dropped
     *
     * @param int|null $dropped Number of emails dropped without attempting to deliver due to invalid email or suppression list
     *
     * @return self
     */
     ...
     * Sets hard_bounced
     *
     * @param int|null $hard_bounced Number of emails that resulted in a hard bounce error
     *
     * @return self
     */
     ...
     * Sets soft_bounced
     *
     * @param int|null $soft_bounced Number of emails that resulted in a temporary soft bounce error
     *
     * @return self
     */
     ...
     * Sets unsubscribed
     *
     * @param int|null $unsubscribed Number of email recipients who unsubscribed
     *
     * @return self
     */
     ...
     * Sets spam
     *
     * @param int|null $spam Number of emails marked as spam by recipients
     *
     * @return self
     */
