...
class Stat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'stats' => '\sendpost\model\StatStats'
    ];
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Date for which stats are retrieved (UTC).
     *
     * @return self
     */
     ...
     * Gets stats
     *
     * @return \sendpost\model\StatStats|null
     */
     ...
     * Sets stats
     *
     * @param \sendpost\model\StatStats|null $stats stats
     *
     * @return self
     */
