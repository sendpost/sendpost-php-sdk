...
class EmailMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'email_type' => 'string',
        'submitted_at' => 'int',
        'from' => '\sendpost\model\EmailMessageFrom',
        'reply_to' => '\sendpost\model\EmailMessageReplyTo',
        'to' => '\sendpost\model\EmailMessageToInner[]',
        'groups' => 'string[]',
        'ip_pool' => 'string',
    ...
    */
     ...
     * Gets from
     *
     * @return \sendpost\model\EmailMessageFrom|null
     */
     ...
     * Sets from
     *
     * @param \sendpost\model\EmailMessageFrom|null $from from
     *
     * @return self
     */
     ...
     * Gets reply_to
     *
     * @return \sendpost\model\EmailMessageReplyTo|null
     */
     ...
     * Sets reply_to
     *
     * @param \sendpost\model\EmailMessageReplyTo|null $reply_to reply_to
     *
     * @return self
     */
     ...
     * Gets to
     *
     * @return \sendpost\model\EmailMessageToInner[]|null
     */
     ...
     * Sets to
     *
     * @param \sendpost\model\EmailMessageToInner[]|null $to to
     *
     * @return self
     */
