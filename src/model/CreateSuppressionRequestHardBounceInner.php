...
/**
 * CreateSuppressionRequestHardBounceInner Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class CreateSuppressionRequestHardBounceInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSuppression_request_hardBounce_inner';
