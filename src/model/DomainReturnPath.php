...
/**
 * DomainReturnPath Class Doc Comment
 *
 * @category Class
 * @description ReturnPath record host, type and value
 * @package  sendpost
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DomainReturnPath implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Domain_returnPath';
