...
class IPPool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPPool';
    ...
    protected static $openAPITypes = [
        ...
        'infra_monitor' => 'bool',
        'ip_domain_warmup_status' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'ip_domain_warmup_status' => 'ipDomainWarmupStatus',
        'should_overflow' => 'shouldOverflow',
    ...
    protected static $setters = [
        ...
        'ip_domain_warmup_status' => 'setIpDomainWarmupStatus',
        'should_overflow' => 'setShouldOverflow',
    ...
    protected static $getters = [
        ...
        'ip_domain_warmup_status' => 'getIpDomainWarmupStatus',
        'should_overflow' => 'getShouldOverflow',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ip_domain_warmup_status', $data ?? [], null);
        $this->setIfExists('should_overflow', $data ?? [], null);
    ...
    */
     ...
     * Sets ips
     *
     * @param \sendpost\model\IP[]|null $ips ips
     *
     * @return self
     */
    ...
    /**
     * Gets third_party_sending_providers
     *
     * @return \sendpost\model\ThirdPartySendingProvider[]|null
     */
    public function getThirdPartySendingProviders()
    {
        return $this->container['third_party_sending_providers'];
    }

    /**
     * Sets third_party_sending_providers
     *
     * @param \sendpost\model\ThirdPartySendingProvider[]|null $third_party_sending_providers third_party_sending_providers
     *
     * @return self
     */
    public function setThirdPartySendingProviders($third_party_sending_providers)
    {
        if (is_null($third_party_sending_providers)) {
     ...
     *
     * @param int|null $routing_strategy routing_strategy
     *
     * @return self
     */
     ...
     *
     * @param string|null $routing_meta_data routing_meta_data
     *
     * @return self
     */
    public function setRoutingMetaData($routing_meta_data)
    {
        if (is_null($routing_meta_data)) {
            throw new \InvalidArgumentException('non-nullable routing_meta_data cannot be null');
        }
     ...
     *
     * @param bool|null $auto_warmup_enabled auto_warmup_enabled
     *
     * @return self
     */
    public function setAutoWarmupEnabled($auto_warmup_enabled)
    {
        if (is_null($auto_warmup_enabled)) {
            throw new \InvalidArgumentException('non-nullable auto_warmup_enabled cannot be null');
        }
     ...
     * Sets infra_monitor
     *
     * @param bool|null $infra_monitor infra_monitor
     *
     * @return self
     */
    ...
    /**
     * Gets ip_domain_warmup_status
     *
     * @return string|null
     */
    public function getIpDomainWarmupStatus()
    {
        return $this->container['ip_domain_warmup_status'];
    }

    /**
     * Sets ip_domain_warmup_status
     *
     * @param string|null $ip_domain_warmup_status ip_domain_warmup_status
     *
     * @return self
     */
    public function setIpDomainWarmupStatus($ip_domain_warmup_status)
    {
        if (is_null($ip_domain_warmup_status)) {
            throw new \InvalidArgumentException('non-nullable ip_domain_warmup_status cannot be null');
        }
        $this->container['ip_domain_warmup_status'] = $ip_domain_warmup_status;

        return $this;
    }

    /**
     * Gets should_overflow
     *
     * @return bool|null
     */
    public function getShouldOverflow()
    {
        return $this->container['should_overflow'];
    }

    /**
     * Sets should_overflow
     *
     * @param bool|null $should_overflow Indicates whether the IP should overflow, once email capacity of the IP Pool has been reached, should we send remaining emails over shared IP or not
     *
     * @return self
     */
    public function setShouldOverflow($should_overflow)
    {
        if (is_null($should_overflow)) {
            throw new \InvalidArgumentException('non-nullable should_overflow cannot be null');
        }
        $this->container['should_overflow'] = $should_overflow;
     ...
     *
     * @param string|null $overflow_pool_name The name of the overflow pool
     *
     * @return self
     */
     ...
     *
     * @param int|null $warmup_interval The interval for the warmup
     *
     * @return self
     */
