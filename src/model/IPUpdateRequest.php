...
/**
 * IPUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class IPUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPUpdateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['auto_warmup_enabled'] === null) {
            $invalidProperties[] = "'auto_warmup_enabled' can't be null";
        }
     ...
     *
     * @param bool $auto_warmup_enabled Whether the IP warmup should happen automatically or be managed manually
     *
     * @return self
     */
