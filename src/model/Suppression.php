...
class Suppression implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('smtp_error', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the suppression
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param int|null $reason The reason for the suppression (0 = manual, 1 = unsubscribe, 2 = hard bounce, 3 = spam complaint)
     *
     * @return self
     */
    ...
    {
        return $this->container['smtp_error'];
    }

    /**
     * Sets smtp_error
     *
     * @param string|null $smtp_error SMTP error code in case of hard bounce suppression
     *
     * @return self
     */
    public function setSmtpError($smtp_error)
    {
        if (is_null($smtp_error)) {
            throw new \InvalidArgumentException('non-nullable smtp_error cannot be null');
        }
        $this->container['smtp_error'] = $smtp_error;
     ...
     * Sets email
     *
     * @param string|null $email The email address for the suppression
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param int|null $created UNIX epoch nano timestamp when the suppression was created
     *
     * @return self
     */
