...
/**
 * EmailMessageWithTemplate Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class EmailMessageWithTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailMessageWithTemplate';
    ...
    protected static $openAPITypes = [
        'from' => '\sendpost\model\EmailAddress',
        'reply_to' => '\sendpost\model\EmailAddress',
        'to' => '\sendpost\model\Recipient[]',
        'subject' => 'string',
        'pre_text' => 'string',
        'html_body' => 'string',
        'text_body' => 'string',
    ...
    */
     ...
     * Gets from
     *
     * @return \sendpost\model\EmailAddress|null
     */
     ...
     * Sets from
     *
     * @param \sendpost\model\EmailAddress|null $from from
     *
     * @return self
     */
     ...
     * Sets reply_to
     *
     * @param \sendpost\model\EmailAddress|null $reply_to reply_to
     *
     * @return self
     */
     ...
     * Gets to
     *
     * @return \sendpost\model\Recipient[]|null
     */
     ...
     * Sets to
     *
     * @param \sendpost\model\Recipient[]|null $to to
     *
     * @return self
     */
     ...
     *
     * @param string|null $webhook_endpoint webhook_endpoint
     *
     * @return self
     */
     ...
     * Sets template_id
     *
     * @param string|null $template_id Template ID for the email template
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $template_variables Key-Value pair of template variables
     *
     * @return self
     */
