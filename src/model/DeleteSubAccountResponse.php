...
/**
 * DeleteSubAccountResponse Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSubAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteSubAccountResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique ID for the deleted sub-account.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Message confirming the deletion.
     *
     * @return self
     */
