...
class WebhookObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'event' => '\sendpost\model\Event',
        'email_message' => '\sendpost\model\EmailMessage'
    ];
    ...
    */
     ...
     * Gets event
     *
     * @return \sendpost\model\Event|null
     */
     ...
     * Sets event
     *
     * @param \sendpost\model\Event|null $event event
     *
     * @return self
     */
     ...
     * Gets email_message
     *
     * @return \sendpost\model\EmailMessage|null
     */
     ...
     * Sets email_message
     *
     * @param \sendpost\model\EmailMessage|null $email_message email_message
     *
     * @return self
     */
