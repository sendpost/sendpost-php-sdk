...
/**
 * IPAllocationRequest Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class IPAllocationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPAllocationRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['overflow_pool'] === null) {
            $invalidProperties[] = "'overflow_pool' can't be null";
        }
     ...
     * Sets overflow_pool
     *
     * @param bool $overflow_pool Determines whether emails should be sent over shared IP when the IP pool is full
     *
     * @return self
     */
