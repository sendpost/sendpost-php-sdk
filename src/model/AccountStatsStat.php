...
/**
 * AccountStatsStat Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class AccountStatsStat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountStats_stat';
    ...
    */
     ...
     * Sets dropped
     *
     * @param int|null $dropped dropped
     *
     * @return self
     */
     ...
     * Sets smtp_dropped
     *
     * @param int|null $smtp_dropped smtp_dropped
     *
     * @return self
     */
     ...
     * Sets hard_bounced
     *
     * @param int|null $hard_bounced hard_bounced
     *
     * @return self
     */
     ...
     * Sets soft_bounced
     *
     * @param int|null $soft_bounced soft_bounced
     *
     * @return self
     */
