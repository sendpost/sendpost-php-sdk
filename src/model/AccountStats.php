...
/**
 * AccountStats Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class AccountStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountStats';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'stat' => '\sendpost\model\AccountStatsStat'
    ];
    ...
    */
     ...
     * Gets stat
     *
     * @return \sendpost\model\AccountStatsStat|null
     */
     ...
     * Sets stat
     *
     * @param \sendpost\model\AccountStatsStat|null $stat stat
     *
     * @return self
     */
