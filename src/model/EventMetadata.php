...
class EventMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'os' => '\sendpost\model\OperatingSystem',
        'device' => '\sendpost\model\Device',
        'geo' => '\sendpost\model\GeoLocation',
        'clicked_url' => 'string',
        'tracked_ip' => 'string',
    ...
    protected static $setters = [
        ...
        'tracked_ip' => 'setTrackedIp',
        'raw_user_agent' => 'setRawUserAgent'
    ];
    ...
    protected static $getters = [
        ...
        'tracked_ip' => 'getTrackedIp',
        'raw_user_agent' => 'getRawUserAgent'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tracked_ip', $data ?? [], null);
        $this->setIfExists('raw_user_agent', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets os
     *
     * @return \sendpost\model\OperatingSystem|null
     */
     ...
     * Sets os
     *
     * @param \sendpost\model\OperatingSystem|null $os os
     *
     * @return self
     */
     ...
     * Gets geo
     *
     * @return \sendpost\model\GeoLocation|null
     */
     ...
     * Sets geo
     *
     * @param \sendpost\model\GeoLocation|null $geo geo
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getTrackedIp()
    {
        return $this->container['tracked_ip'];
    }

    /**
     * Sets tracked_ip
     *
     * @param string|null $tracked_ip tracked_ip
     *
     * @return self
     */
    public function setTrackedIp($tracked_ip)
    {
        if (is_null($tracked_ip)) {
            throw new \InvalidArgumentException('non-nullable tracked_ip cannot be null');
        }
        $this->container['tracked_ip'] = $tracked_ip;
    ...
    {
        return $this->container['raw_user_agent'];
    }

    /**
     * Sets raw_user_agent
     *
     * @param string|null $raw_user_agent raw_user_agent
     *
     * @return self
     */
    public function setRawUserAgent($raw_user_agent)
    {
        if (is_null($raw_user_agent)) {
            throw new \InvalidArgumentException('non-nullable raw_user_agent cannot be null');
        }
        $this->container['raw_user_agent'] = $raw_user_agent;
