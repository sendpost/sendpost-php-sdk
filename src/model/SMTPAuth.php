 ...
 */
class SMTPAuth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SMTPAuth';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique ID for the SMTP Auth
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string|null $username Username for the SMTP Auth
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Password for the SMTP Auth
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param int|null $created UNIX epoch nano timestamp when the SMTP Auth was created
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param int|null $updated UNIX epoch nano timestamp when the SMTP Auth was updated
     *
     * @return self
     */
