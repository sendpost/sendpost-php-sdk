...
/**
 * ThirdPartySendingProvider Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class ThirdPartySendingProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThirdPartySendingProvider';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('retry_time', $data ?? [], null);
    ...
    */
     ...
     * Sets oauth_token
     *
     * @param string|null $oauth_token oauth_token
     *
     * @return self
     */
    ...
    {
        return $this->container['retry_time'];
    }

    /**
     * Sets retry_time
     *
     * @param int|null $retry_time retry_time
     *
     * @return self
     */
    public function setRetryTime($retry_time)
    {
        if (is_null($retry_time)) {
            throw new \InvalidArgumentException('non-nullable retry_time cannot be null');
        }
        $this->container['retry_time'] = $retry_time;
