...
/**
 * MessageHeaderTo Class Doc Comment
 *
 * @category Class
 * @description Header To recipient object comprising name, email, cc, bcc and customFields
 * @package  sendpost
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MessageHeaderTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Message_headerTo';
    ...
    */
     ...
     * Sets cc
     *
     * @param string[]|null $cc List of CC recipients
     *
     * @return self
     */
     ...
     * Sets bcc
     *
     * @param string[]|null $bcc List of BCC recipients
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param array<string,string>|null $custom_fields Key-Value pair of custom fields.
     *
     * @return self
     */
