...
/**
 * CreateSuppressionRequestUnsubscribeInner Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class CreateSuppressionRequestUnsubscribeInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSuppression_request_unsubscribe_inner';
