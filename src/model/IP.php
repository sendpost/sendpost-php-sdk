...
class IP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets system_domain
     *
     * @param \sendpost\model\Domain|null $system_domain Details of the system domain associated with the IP
     *
     * @return self
     */
     ...
     *
     * @param string|null $auto_warmup_plan The auto-warmup plan associated with the IP
     *
     * @return self
     */
