...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique ID for the webhook.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Indicates if the webhook is active or paused.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url URL endpoint to which webhook calls need to be made.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param int|null $created UNIX epoch nano timestamp when the webhook was created.
     *
     * @return self
     */
