...
class Member implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('firebase_uid', $data ?? [], null);
        $this->setIfExists('email', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('url', $data ?? [], null);
        $this->setIfExists('company_name', $data ?? [], null);
        $this->setIfExists('onboard_q_answered', $data ?? [], null);
        $this->setIfExists('phone_number', $data ?? [], null);
        $this->setIfExists('notes_color', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique ID for the member
     *
     * @return self
     */
     ...
     * Sets is_verified
     *
     * @param bool|null $is_verified Indicates whether the member is verified
     *
     * @return self
     */
     ...
     * Sets is_forbidden
     *
     * @param bool|null $is_forbidden Indicates whether the member is forbidden
     *
     * @return self
     */
    ...
    {
        return $this->container['firebase_uid'];
    }

    /**
     * Sets firebase_uid
     *
     * @param string|null $firebase_uid Firebase UID for the member
     *
     * @return self
     */
    public function setFirebaseUid($firebase_uid)
    {
        if (is_null($firebase_uid)) {
            throw new \InvalidArgumentException('non-nullable firebase_uid cannot be null');
        }
        $this->container['firebase_uid'] = $firebase_uid;
     ...
     * Sets email
     *
     * @param string|null $email Email for the member
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name for the member
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Logo URL for the member
     *
     * @return self
     */
     ...
     * Sets company_name
     *
     * @param string|null $company_name Company name for the member
     *
     * @return self
     */
     ...
     *
     * @param bool|null $onboard_q_answered Indicates whether the member has answered onboarding question
     *
     * @return self
     */
    public function setOnboardQAnswered($onboard_q_answered)
    {
        if (is_null($onboard_q_answered)) {
            throw new \InvalidArgumentException('non-nullable onboard_q_answered cannot be null');
        }
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number for the member
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getNotesColor()
    {
        return $this->container['notes_color'];
    }

    /**
     * Sets notes_color
     *
     * @param string|null $notes_color Color for the member's notes
     *
     * @return self
     */
    public function setNotesColor($notes_color)
    {
        if (is_null($notes_color)) {
            throw new \InvalidArgumentException('non-nullable notes_color cannot be null');
        }
        $this->container['notes_color'] = $notes_color;
     ...
     * Sets created
     *
     * @param int|null $created UNIX epoch nano timestamp when the member was created
     *
     * @return self
     */
