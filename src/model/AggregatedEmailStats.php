...
/**
 * AggregatedEmailStats Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class AggregatedEmailStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AggregatedEmailStats';
    ...
    */
     ...
     * Sets processed
     *
     * @param int|null $processed Total number of emails accepted by SendPost API
     *
     * @return self
     */
     ...
     * Sets delivered
     *
     * @param int|null $delivered Total number of emails successfully delivered to SMTP
     *
     * @return self
     */
     ...
     * Sets dropped
     *
     * @param int|null $dropped Total number of emails dropped without delivery
     *
     * @return self
     */
     ...
     * Sets hard_bounced
     *
     * @param int|null $hard_bounced Total number of hard bounce errors
     *
     * @return self
     */
     ...
     * Sets soft_bounced
     *
     * @param int|null $soft_bounced Total number of soft bounce errors
     *
     * @return self
     */
     ...
     * Sets opened
     *
     * @param int|null $opened Total number of emails opened by recipients
     *
     * @return self
     */
     ...
     * Sets clicked
     *
     * @param int|null $clicked Total number of links clicked by recipients
     *
     * @return self
     */
     ...
     * Sets unsubscribed
     *
     * @param int|null $unsubscribed Total number of unsubscribed recipients
     *
     * @return self
     */
     ...
     * Sets spam
     *
     * @param int|null $spam Total number of spams reported by recipients
     *
     * @return self
     */
