...
/**
 * DeleteSuppression200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSuppression200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deleteSuppression_200_response_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the deleted suppression
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A success message after the suppression(s) are deleted
     *
     * @return self
     */
