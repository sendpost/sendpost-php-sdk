...
/**
 * DeleteSuppressionRequest Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSuppressionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deleteSuppression_request';
    ...
    protected static $openAPITypes = [
        'suppressions' => '\sendpost\model\CreateSuppressionRequestSpamComplaintInner[]'
    ];
    ...
    {
        $this->setIfExists('suppressions', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets suppressions
     *
     * @param \sendpost\model\CreateSuppressionRequestSpamComplaintInner[]|null $suppressions suppressions
     *
     * @return self
     */
    public function setSuppressions($suppressions)
    {
        if (is_null($suppressions)) {
            throw new \InvalidArgumentException('non-nullable suppressions cannot be null');
        }
