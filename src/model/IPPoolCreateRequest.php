...
/**
 * IPPoolCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
 ...
 */
class IPPoolCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPPoolCreateRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tpsps', $data ?? [], null);
    ...
    */
     ...
     * Gets ips
     *
     * @return \sendpost\model\EIP[]|null
     */
     ...
     * Sets ips
     *
     * @param \sendpost\model\EIP[]|null $ips ips
     *
     * @return self
     */
     ...
     * @return int[]|null
     */
    public function getTpsps()
    {
        return $this->container['tpsps'];
    }

    /**
     * Sets tpsps
     *
     * @param int[]|null $tpsps tpsps
     *
     * @return self
     */
    public function setTpsps($tpsps)
    {
        if (is_null($tpsps)) {
            throw new \InvalidArgumentException('non-nullable tpsps cannot be null');
        }
        $this->container['tpsps'] = $tpsps;
     ...
     * @return bool|null
     */
    public function getOverflowPool()
    {
        return $this->container['overflow_pool'];
    }

    /**
     * Sets overflow_pool
     *
     * @param bool|null $overflow_pool overflow_pool
     *
     * @return self
     */
    public function setOverflowPool($overflow_pool)
    {
        if (is_null($overflow_pool)) {
