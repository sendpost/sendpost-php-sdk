...
/**
 * DomainTrack Class Doc Comment
 *
 * @category Class
 * @description Track record host, type and value. This domain will be used for link tracking while rewriting links in your email message
 * @package  sendpost
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DomainTrack implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Domain_track';
