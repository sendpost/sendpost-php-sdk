...
class IPApi
{
    ...
    /**
     * Operation allocateNewIp
     *
     * Allocate IP
     *
     * @param  \sendpost\model\IPAllocationRequest $ip_allocation_request ip_allocation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['allocateNewIp'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IP
     */
    public function allocateNewIp($ip_allocation_request, string $contentType = self::contentTypes['allocateNewIp'][0])
    {
        list($response) = $this->allocateNewIpWithHttpInfo($ip_allocation_request, $contentType);
        return $response;
    }

    /**
     * Operation allocateNewIpWithHttpInfo
     *
     * Allocate IP
     *
     * @param  \sendpost\model\IPAllocationRequest $ip_allocation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['allocateNewIp'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\IP, HTTP status code, HTTP response headers (array of strings)
     */
    public function allocateNewIpWithHttpInfo($ip_allocation_request, string $contentType = self::contentTypes['allocateNewIp'][0])
    {
        $request = $this->allocateNewIpRequest($ip_allocation_request, $contentType);
     ...
     */
    public function allocateNewIpAsync($ip_allocation_request, string $contentType = self::contentTypes['allocateNewIp'][0])
    {
        return $this->allocateNewIpAsyncWithHttpInfo($ip_allocation_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation allocateNewIpAsyncWithHttpInfo
     *
     * Allocate IP
     *
     * @param  \sendpost\model\IPAllocationRequest $ip_allocation_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function allocateNewIpAsyncWithHttpInfo($ip_allocation_request, string $contentType = self::contentTypes['allocateNewIp'][0])
    {
        $returnType = '\sendpost\model\IP';
        $request = $this->allocateNewIpRequest($ip_allocation_request, $contentType);
    ...
    /**
     * Create request for operation 'allocateNewIp'
     *
     * @param  \sendpost\model\IPAllocationRequest $ip_allocation_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['allocateNewIp'] to see the possible values for this operation
     *
     ...
     */
    public function allocateNewIpRequest($ip_allocation_request, string $contentType = self::contentTypes['allocateNewIp'][0])
    {

        // verify the required parameter 'ip_allocation_request' is set
        if ($ip_allocation_request === null || (is_array($ip_allocation_request) && count($ip_allocation_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_allocation_request when calling allocateNewIp'
            );
        }
        ...
        // for model (json/xml)
        if (isset($ip_allocation_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ip_allocation_request));
            } else {
                $httpBody = $ip_allocation_request;
            }
     ...
     * Delete IP
     *
     * @param  int $ip_id The ID of the IP resource to delete (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IPDeletionResponse
     */
    public function deleteIp($ip_id, string $contentType = self::contentTypes['deleteIp'][0])
    {
        list($response) = $this->deleteIpWithHttpInfo($ip_id, $contentType);
        return $response;
    }
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\IPDeletionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteIpWithHttpInfo($ip_id, string $contentType = self::contentTypes['deleteIp'][0])
    {
        $request = $this->deleteIpRequest($ip_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\sendpost\model\IPDeletionResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIpAsync($ip_id, string $contentType = self::contentTypes['deleteIp'][0])
    {
        return $this->deleteIpAsyncWithHttpInfo($ip_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIpAsyncWithHttpInfo($ip_id, string $contentType = self::contentTypes['deleteIp'][0])
    {
        $returnType = '\sendpost\model\IPDeletionResponse';
        $request = $this->deleteIpRequest($ip_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteIpRequest($ip_id, string $contentType = self::contentTypes['deleteIp'][0])
    {

        // verify the required parameter 'ip_id' is set
        if ($ip_id === null || (is_array($ip_id) && count($ip_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_id when calling deleteIp'
            );
        }


        $resourcePath = '/account/ip/{ip_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string|null $search Case insensitive search against IP&#39;s public IP address (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllIps'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IP[]
     */
    public function getAllIps($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIps'][0])
    {
        list($response) = $this->getAllIpsWithHttpInfo($limit, $offset, $search, $contentType);
        return $response;
    }

    /**
     * Operation getAllIpsWithHttpInfo
     *
     * List IPs
     *
     * @param  int|null $limit Number of records to return per request (optional)
     ...
     * @return array of \sendpost\model\IP[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllIpsWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIps'][0])
    {
        $request = $this->getAllIpsRequest($limit, $offset, $search, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllIpsAsync($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIps'][0])
    {
        return $this->getAllIpsAsyncWithHttpInfo($limit, $offset, $search, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllIpsAsyncWithHttpInfo
     *
     * List IPs
     *
     * @param  int|null $limit Number of records to return per request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllIpsAsyncWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIps'][0])
    {
        $returnType = '\sendpost\model\IP[]';
        $request = $this->getAllIpsRequest($limit, $offset, $search, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllIpsRequest($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIps'][0])
    {
    ...
    /**
     * Operation getSpecificIp
     *
     * Get IP
     *
     * @param  int $ip_id The ID of the IP resource to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSpecificIp'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IP
     */
    public function getSpecificIp($ip_id, string $contentType = self::contentTypes['getSpecificIp'][0])
    {
        list($response) = $this->getSpecificIpWithHttpInfo($ip_id, $contentType);
        return $response;
    }

    /**
     * Operation getSpecificIpWithHttpInfo
     *
     * Get IP
     *
     * @param  int $ip_id The ID of the IP resource to retrieve (required)
     ...
     * @return array of \sendpost\model\IP, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSpecificIpWithHttpInfo($ip_id, string $contentType = self::contentTypes['getSpecificIp'][0])
    {
        $request = $this->getSpecificIpRequest($ip_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecificIpAsync($ip_id, string $contentType = self::contentTypes['getSpecificIp'][0])
    {
        return $this->getSpecificIpAsyncWithHttpInfo($ip_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSpecificIpAsyncWithHttpInfo
     *
     * Get IP
     *
     * @param  int $ip_id The ID of the IP resource to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSpecificIpAsyncWithHttpInfo($ip_id, string $contentType = self::contentTypes['getSpecificIp'][0])
    {
        $returnType = '\sendpost\model\IP';
        $request = $this->getSpecificIpRequest($ip_id, $contentType);
    ...
    /**
     * Create request for operation 'getSpecificIp'
     *
     * @param  int $ip_id The ID of the IP resource to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSpecificIp'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSpecificIpRequest($ip_id, string $contentType = self::contentTypes['getSpecificIp'][0])
    {

        // verify the required parameter 'ip_id' is set
        if ($ip_id === null || (is_array($ip_id) && count($ip_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_id when calling getSpecificIp'
            );
        }
     ...
     * Update IP
     *
     * @param  \sendpost\model\IPUpdateRequest $ip_update_request ip_update_request (required)
     * @param  int $ip_id The ID of the IP resource to update (required)
     ...
     * @return \sendpost\model\IP
     */
    public function updateIp($ip_update_request, $ip_id, string $contentType = self::contentTypes['updateIp'][0])
    {
        list($response) = $this->updateIpWithHttpInfo($ip_update_request, $ip_id, $contentType);
        return $response;
    }
     ...
     * Update IP
     *
     * @param  \sendpost\model\IPUpdateRequest $ip_update_request (required)
     * @param  int $ip_id The ID of the IP resource to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateIp'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \sendpost\model\IP, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateIpWithHttpInfo($ip_update_request, $ip_id, string $contentType = self::contentTypes['updateIp'][0])
    {
        $request = $this->updateIpRequest($ip_update_request, $ip_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIpAsync($ip_update_request, $ip_id, string $contentType = self::contentTypes['updateIp'][0])
    {
        return $this->updateIpAsyncWithHttpInfo($ip_update_request, $ip_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIpAsyncWithHttpInfo($ip_update_request, $ip_id, string $contentType = self::contentTypes['updateIp'][0])
    {
        $returnType = '\sendpost\model\IP';
        $request = $this->updateIpRequest($ip_update_request, $ip_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateIpRequest($ip_update_request, $ip_id, string $contentType = self::contentTypes['updateIp'][0])
    {

        // verify the required parameter 'ip_update_request' is set
        if ($ip_update_request === null || (is_array($ip_update_request) && count($ip_update_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_update_request when calling updateIp'
            );
        }
        ...
        if ($ip_id === null || (is_array($ip_id) && count($ip_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_id when calling updateIp'
            );
        }
        ...
        // for model (json/xml)
        if (isset($ip_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ip_update_request));
            } else {
                $httpBody = $ip_update_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
