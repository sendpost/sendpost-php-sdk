...
class IPPoolsApi
{
     ...
     * Create IPPool
     *
     * @param  \sendpost\model\IPPoolCreateRequest $ip_pool_create_request ip_pool_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createIPPool'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IPPool
     */
    public function createIPPool($ip_pool_create_request, string $contentType = self::contentTypes['createIPPool'][0])
    {
        list($response) = $this->createIPPoolWithHttpInfo($ip_pool_create_request, $contentType);
        return $response;
    }

    /**
     * Operation createIPPoolWithHttpInfo
     *
     * Create IPPool
     *
     * @param  \sendpost\model\IPPoolCreateRequest $ip_pool_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createIPPool'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\IPPool, HTTP status code, HTTP response headers (array of strings)
     */
    public function createIPPoolWithHttpInfo($ip_pool_create_request, string $contentType = self::contentTypes['createIPPool'][0])
    {
        $request = $this->createIPPoolRequest($ip_pool_create_request, $contentType);
     ...
     */
    public function createIPPoolAsync($ip_pool_create_request, string $contentType = self::contentTypes['createIPPool'][0])
    {
        return $this->createIPPoolAsyncWithHttpInfo($ip_pool_create_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createIPPoolAsyncWithHttpInfo
     *
     * Create IPPool
     *
     * @param  \sendpost\model\IPPoolCreateRequest $ip_pool_create_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createIPPoolAsyncWithHttpInfo($ip_pool_create_request, string $contentType = self::contentTypes['createIPPool'][0])
    {
        $returnType = '\sendpost\model\IPPool';
        $request = $this->createIPPoolRequest($ip_pool_create_request, $contentType);
     ...
     */
    public function createIPPoolRequest($ip_pool_create_request, string $contentType = self::contentTypes['createIPPool'][0])
    {

        // verify the required parameter 'ip_pool_create_request' is set
        if ($ip_pool_create_request === null || (is_array($ip_pool_create_request) && count($ip_pool_create_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_pool_create_request when calling createIPPool'
            );
        }
        ...
        // for model (json/xml)
        if (isset($ip_pool_create_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ip_pool_create_request));
            } else {
                $httpBody = $ip_pool_create_request;
            }
     ...
     * Delete IPPool
     *
     * @param  int $ippool_id The ID of the IPPool to delete (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteIPPool'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IPPoolDeleteResponse
     */
    public function deleteIPPool($ippool_id, string $contentType = self::contentTypes['deleteIPPool'][0])
    {
        list($response) = $this->deleteIPPoolWithHttpInfo($ippool_id, $contentType);
        return $response;
    }

    /**
     * Operation deleteIPPoolWithHttpInfo
     *
     * Delete IPPool
     *
     * @param  int $ippool_id The ID of the IPPool to delete (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\IPPoolDeleteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteIPPoolWithHttpInfo($ippool_id, string $contentType = self::contentTypes['deleteIPPool'][0])
    {
        $request = $this->deleteIPPoolRequest($ippool_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\sendpost\model\IPPoolDeleteResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIPPoolAsync($ippool_id, string $contentType = self::contentTypes['deleteIPPool'][0])
    {
        return $this->deleteIPPoolAsyncWithHttpInfo($ippool_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteIPPoolAsyncWithHttpInfo
     *
     * Delete IPPool
     *
     * @param  int $ippool_id The ID of the IPPool to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIPPoolAsyncWithHttpInfo($ippool_id, string $contentType = self::contentTypes['deleteIPPool'][0])
    {
        $returnType = '\sendpost\model\IPPoolDeleteResponse';
        $request = $this->deleteIPPoolRequest($ippool_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteIPPoolRequest($ippool_id, string $contentType = self::contentTypes['deleteIPPool'][0])
    {

        // verify the required parameter 'ippool_id' is set
        if ($ippool_id === null || (is_array($ippool_id) && count($ippool_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ippool_id when calling deleteIPPool'
            );
        }


        $resourcePath = '/account/ippool/{ippool_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($ippool_id !== null) {
            $resourcePath = str_replace(
                '{' . 'ippool_id' . '}',
                ObjectSerializer::toPathValue($ippool_id),
                $resourcePath
            );
        }
     ...
     * @param  string|null $search Case insensitive search against IPPool name (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllIPPools'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IPPool[]
     */
    public function getAllIPPools($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIPPools'][0])
    {
        list($response) = $this->getAllIPPoolsWithHttpInfo($limit, $offset, $search, $contentType);
        return $response;
    }

    /**
     * Operation getAllIPPoolsWithHttpInfo
     *
     * List IPPools
     *
     * @param  int|null $limit Number of records to return per request (optional)
     ...
     * @return array of \sendpost\model\IPPool[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllIPPoolsWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIPPools'][0])
    {
        $request = $this->getAllIPPoolsRequest($limit, $offset, $search, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllIPPoolsAsync($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIPPools'][0])
    {
        return $this->getAllIPPoolsAsyncWithHttpInfo($limit, $offset, $search, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllIPPoolsAsyncWithHttpInfo
     *
     * List IPPools
     *
     * @param  int|null $limit Number of records to return per request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllIPPoolsAsyncWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIPPools'][0])
    {
        $returnType = '\sendpost\model\IPPool[]';
        $request = $this->getAllIPPoolsRequest($limit, $offset, $search, $contentType);
    ...
    /**
     * Create request for operation 'getAllIPPools'
     *
     * @param  int|null $limit Number of records to return per request (optional)
     * @param  int|null $offset Number of initial records to skip (optional)
     * @param  string|null $search Case insensitive search against IPPool name (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllIPPoolsRequest($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllIPPools'][0])
    {
    ...
    /**
     * Operation getIPPoolById
     *
     * Get IPPool
     *
     * @param  int $ippool_id The ID of the IPPool whose information you want to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIPPoolById'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IPPool
     */
    public function getIPPoolById($ippool_id, string $contentType = self::contentTypes['getIPPoolById'][0])
    {
        list($response) = $this->getIPPoolByIdWithHttpInfo($ippool_id, $contentType);
        return $response;
    }

    /**
     * Operation getIPPoolByIdWithHttpInfo
     *
     * Get IPPool
     *
     * @param  int $ippool_id The ID of the IPPool whose information you want to retrieve (required)
     ...
     * @return array of \sendpost\model\IPPool, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIPPoolByIdWithHttpInfo($ippool_id, string $contentType = self::contentTypes['getIPPoolById'][0])
    {
        $request = $this->getIPPoolByIdRequest($ippool_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIPPoolByIdAsync($ippool_id, string $contentType = self::contentTypes['getIPPoolById'][0])
    {
        return $this->getIPPoolByIdAsyncWithHttpInfo($ippool_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getIPPoolByIdAsyncWithHttpInfo
     *
     * Get IPPool
     *
     * @param  int $ippool_id The ID of the IPPool whose information you want to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIPPoolByIdAsyncWithHttpInfo($ippool_id, string $contentType = self::contentTypes['getIPPoolById'][0])
    {
        $returnType = '\sendpost\model\IPPool';
        $request = $this->getIPPoolByIdRequest($ippool_id, $contentType);
    ...
    /**
     * Create request for operation 'getIPPoolById'
     *
     * @param  int $ippool_id The ID of the IPPool whose information you want to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIPPoolById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIPPoolByIdRequest($ippool_id, string $contentType = self::contentTypes['getIPPoolById'][0])
    {

        // verify the required parameter 'ippool_id' is set
        if ($ippool_id === null || (is_array($ippool_id) && count($ippool_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ippool_id when calling getIPPoolById'
            );
        }
     ...
     * Update IPPool
     *
     * @param  \sendpost\model\IPPoolUpdateRequest $ip_pool_update_request ip_pool_update_request (required)
     * @param  int $ippool_id The ID of the IPPool to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateIPPool'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\IPPool
     */
    public function updateIPPool($ip_pool_update_request, $ippool_id, string $contentType = self::contentTypes['updateIPPool'][0])
    {
        list($response) = $this->updateIPPoolWithHttpInfo($ip_pool_update_request, $ippool_id, $contentType);
        return $response;
    }

    /**
     * Operation updateIPPoolWithHttpInfo
     *
     * Update IPPool
     *
     * @param  \sendpost\model\IPPoolUpdateRequest $ip_pool_update_request (required)
     * @param  int $ippool_id The ID of the IPPool to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateIPPool'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \sendpost\model\IPPool, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateIPPoolWithHttpInfo($ip_pool_update_request, $ippool_id, string $contentType = self::contentTypes['updateIPPool'][0])
    {
        $request = $this->updateIPPoolRequest($ip_pool_update_request, $ippool_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIPPoolAsync($ip_pool_update_request, $ippool_id, string $contentType = self::contentTypes['updateIPPool'][0])
    {
        return $this->updateIPPoolAsyncWithHttpInfo($ip_pool_update_request, $ippool_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateIPPoolAsyncWithHttpInfo
     *
     * Update IPPool
     *
     * @param  \sendpost\model\IPPoolUpdateRequest $ip_pool_update_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateIPPoolAsyncWithHttpInfo($ip_pool_update_request, $ippool_id, string $contentType = self::contentTypes['updateIPPool'][0])
    {
        $returnType = '\sendpost\model\IPPool';
        $request = $this->updateIPPoolRequest($ip_pool_update_request, $ippool_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateIPPoolRequest($ip_pool_update_request, $ippool_id, string $contentType = self::contentTypes['updateIPPool'][0])
    {

        // verify the required parameter 'ip_pool_update_request' is set
        if ($ip_pool_update_request === null || (is_array($ip_pool_update_request) && count($ip_pool_update_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ip_pool_update_request when calling updateIPPool'
            );
        }
        ...
        if ($ippool_id === null || (is_array($ippool_id) && count($ippool_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ippool_id when calling updateIPPool'
            );
        }
        ...
        // for model (json/xml)
        if (isset($ip_pool_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ip_pool_update_request));
            } else {
                $httpBody = $ip_pool_update_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
