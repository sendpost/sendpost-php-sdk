...
/**
 * WebhookReferenceApi Class Doc Comment
 *
 * @category Class
 * @package  sendpost
 * @author   OpenAPI Generator team
...
class WebhookReferenceApi
{
    ...
    /**
     * Operation sendPostWebhooksPost
     *
     * SendPost Webhook Object
     *
     * @param  \sendpost\model\WebhookObject|null $webhook_object webhook_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendPostWebhooksPost'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function sendPostWebhooksPost($webhook_object = null, string $contentType = self::contentTypes['sendPostWebhooksPost'][0])
    {
        $this->sendPostWebhooksPostWithHttpInfo($webhook_object, $contentType);
    }

    /**
     * Operation sendPostWebhooksPostWithHttpInfo
     *
     * SendPost Webhook Object
     *
     * @param  \sendpost\model\WebhookObject|null $webhook_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendPostWebhooksPost'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function sendPostWebhooksPostWithHttpInfo($webhook_object = null, string $contentType = self::contentTypes['sendPostWebhooksPost'][0])
    {
        $request = $this->sendPostWebhooksPostRequest($webhook_object, $contentType);
    ...
    /**
     * Operation sendPostWebhooksPostAsync
     *
     * SendPost Webhook Object
     *
     * @param  \sendpost\model\WebhookObject|null $webhook_object (optional)
     ...
     */
    public function sendPostWebhooksPostAsync($webhook_object = null, string $contentType = self::contentTypes['sendPostWebhooksPost'][0])
    {
        return $this->sendPostWebhooksPostAsyncWithHttpInfo($webhook_object, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sendPostWebhooksPostAsyncWithHttpInfo
     *
     * SendPost Webhook Object
     *
     * @param  \sendpost\model\WebhookObject|null $webhook_object (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendPostWebhooksPostAsyncWithHttpInfo($webhook_object = null, string $contentType = self::contentTypes['sendPostWebhooksPost'][0])
    {
        $returnType = '';
        $request = $this->sendPostWebhooksPostRequest($webhook_object, $contentType);
    ...
    /**
     * Create request for operation 'sendPostWebhooksPost'
     *
     * @param  \sendpost\model\WebhookObject|null $webhook_object (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendPostWebhooksPost'] to see the possible values for this operation
     *
     ...
     */
    public function sendPostWebhooksPostRequest($webhook_object = null, string $contentType = self::contentTypes['sendPostWebhooksPost'][0])
    {



        $resourcePath = '/SendPostWebhooks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($webhook_object)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_object));
            } else {
                $httpBody = $webhook_object;
            }
