...
class EmailApi
{
     ...
     * Send Email
     *
     * @param  \sendpost\model\EmailMessageObject $email_message_object Email message details (required)
     ...
     */
    public function sendEmail($email_message_object, string $contentType = self::contentTypes['sendEmail'][0])
    {
        list($response) = $this->sendEmailWithHttpInfo($email_message_object, $contentType);
        return $response;
    }
     ...
     */
    public function sendEmailWithHttpInfo($email_message_object, string $contentType = self::contentTypes['sendEmail'][0])
    {
        $request = $this->sendEmailRequest($email_message_object, $contentType);
     ...
     */
    public function sendEmailAsync($email_message_object, string $contentType = self::contentTypes['sendEmail'][0])
    {
        return $this->sendEmailAsyncWithHttpInfo($email_message_object, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailAsyncWithHttpInfo($email_message_object, string $contentType = self::contentTypes['sendEmail'][0])
    {
     ...
     */
    public function sendEmailRequest($email_message_object, string $contentType = self::contentTypes['sendEmail'][0])
    {

        // verify the required parameter 'email_message_object' is set
        if ($email_message_object === null || (is_array($email_message_object) && count($email_message_object) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_message_object when calling sendEmail'
            );
        }
        ...
        // for model (json/xml)
        if (isset($email_message_object)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($email_message_object));
            } else {
                $httpBody = $email_message_object;
            }
     ...
     *
     * @param  \sendpost\model\EmailMessageWithTemplate $email_message_with_template Email message details with template information (required)
     ...
     * @return \sendpost\model\EmailResponse[]
     */
    public function sendEmailWithTemplate($email_message_with_template, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        list($response) = $this->sendEmailWithTemplateWithHttpInfo($email_message_with_template, $contentType);
        return $response;
    }
     ...
     * @return array of \sendpost\model\EmailResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function sendEmailWithTemplateWithHttpInfo($email_message_with_template, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        $request = $this->sendEmailWithTemplateRequest($email_message_with_template, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailWithTemplateAsync($email_message_with_template, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        return $this->sendEmailWithTemplateAsyncWithHttpInfo($email_message_with_template, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailWithTemplateAsyncWithHttpInfo($email_message_with_template, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {
        $returnType = '\sendpost\model\EmailResponse[]';
        $request = $this->sendEmailWithTemplateRequest($email_message_with_template, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendEmailWithTemplateRequest($email_message_with_template, string $contentType = self::contentTypes['sendEmailWithTemplate'][0])
    {

        // verify the required parameter 'email_message_with_template' is set
        if ($email_message_with_template === null || (is_array($email_message_with_template) && count($email_message_with_template) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_message_with_template when calling sendEmailWithTemplate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($email_message_with_template)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($email_message_with_template));
            } else {
                $httpBody = $email_message_with_template;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
