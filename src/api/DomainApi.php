...
class DomainApi
{
     ...
     * @param  string|null $search Case insensitive search against domain names (optional)
     ...
     * @return \sendpost\model\Domain[]
     */
    public function getAllDomains($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllDomains'][0])
    {
        list($response) = $this->getAllDomainsWithHttpInfo($limit, $offset, $search, $contentType);
        return $response;
    }
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\Domain[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllDomainsWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllDomains'][0])
    {
        $request = $this->getAllDomainsRequest($limit, $offset, $search, $contentType);
     ...
     */
    public function getAllDomainsAsync($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllDomains'][0])
    {
        return $this->getAllDomainsAsyncWithHttpInfo($limit, $offset, $search, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllDomainsAsyncWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllDomains'][0])
    {
        $returnType = '\sendpost\model\Domain[]';
        $request = $this->getAllDomainsRequest($limit, $offset, $search, $contentType);
     ...
     */
    public function getAllDomainsRequest($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllDomains'][0])
    {

        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DomainApi.getAllDomains, must be bigger than or equal to 1.');
        }
        
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling DomainApi.getAllDomains, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation subaccountDomainDomainIdDelete
     *
     * Delete Domain
     *
     * @param  string $domain_id The unique ID of the domain to delete. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainDomainIdDelete'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\DeleteResponse
     */
    public function subaccountDomainDomainIdDelete($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdDelete'][0])
    {
        list($response) = $this->subaccountDomainDomainIdDeleteWithHttpInfo($domain_id, $contentType);
        return $response;
    }

    /**
     * Operation subaccountDomainDomainIdDeleteWithHttpInfo
     *
     * Delete Domain
     *
     * @param  string $domain_id The unique ID of the domain to delete. (required)
     ...
     */
    public function subaccountDomainDomainIdDeleteWithHttpInfo($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdDelete'][0])
    {
        $request = $this->subaccountDomainDomainIdDeleteRequest($domain_id, $contentType);
    ...
    /**
     * Operation subaccountDomainDomainIdDeleteAsync
     *
     * Delete Domain
     *
     * @param  string $domain_id The unique ID of the domain to delete. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountDomainDomainIdDeleteAsync($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdDelete'][0])
    {
        return $this->subaccountDomainDomainIdDeleteAsyncWithHttpInfo($domain_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subaccountDomainDomainIdDeleteAsyncWithHttpInfo
     *
     * Delete Domain
     *
     * @param  string $domain_id The unique ID of the domain to delete. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountDomainDomainIdDeleteAsyncWithHttpInfo($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdDelete'][0])
    {
    ...
    /**
     * Create request for operation 'subaccountDomainDomainIdDelete'
     *
     * @param  string $domain_id The unique ID of the domain to delete. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainDomainIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function subaccountDomainDomainIdDeleteRequest($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdDelete'][0])
    {

        // verify the required parameter 'domain_id' is set
        if ($domain_id === null || (is_array($domain_id) && count($domain_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_id when calling subaccountDomainDomainIdDelete'
            );
        }


        $resourcePath = '/subaccount/domain/{domain_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation subaccountDomainDomainIdGet
     *
     * Get Domain
     *
     * @param  string $domain_id The unique ID of the domain to retrieve. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainDomainIdGet'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\Domain
     */
    public function subaccountDomainDomainIdGet($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdGet'][0])
    {
        list($response) = $this->subaccountDomainDomainIdGetWithHttpInfo($domain_id, $contentType);
        return $response;
    }

    /**
     * Operation subaccountDomainDomainIdGetWithHttpInfo
     *
     * Get Domain
     *
     * @param  string $domain_id The unique ID of the domain to retrieve. (required)
     ...
     * @return array of \sendpost\model\Domain, HTTP status code, HTTP response headers (array of strings)
     */
    public function subaccountDomainDomainIdGetWithHttpInfo($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdGet'][0])
    {
        $request = $this->subaccountDomainDomainIdGetRequest($domain_id, $contentType);
    ...
    /**
     * Operation subaccountDomainDomainIdGetAsync
     *
     * Get Domain
     *
     * @param  string $domain_id The unique ID of the domain to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountDomainDomainIdGetAsync($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdGet'][0])
    {
        return $this->subaccountDomainDomainIdGetAsyncWithHttpInfo($domain_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subaccountDomainDomainIdGetAsyncWithHttpInfo
     *
     * Get Domain
     *
     * @param  string $domain_id The unique ID of the domain to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountDomainDomainIdGetAsyncWithHttpInfo($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdGet'][0])
    {
        $returnType = '\sendpost\model\Domain';
        $request = $this->subaccountDomainDomainIdGetRequest($domain_id, $contentType);
    ...
    /**
     * Create request for operation 'subaccountDomainDomainIdGet'
     *
     * @param  string $domain_id The unique ID of the domain to retrieve. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainDomainIdGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function subaccountDomainDomainIdGetRequest($domain_id, string $contentType = self::contentTypes['subaccountDomainDomainIdGet'][0])
    {

        // verify the required parameter 'domain_id' is set
        if ($domain_id === null || (is_array($domain_id) && count($domain_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_id when calling subaccountDomainDomainIdGet'
            );
        }
    ...
    /**
     * Operation subaccountDomainPost
     *
     * Create Domain
     *
     * @param  \sendpost\model\CreateDomainRequest $create_domain_request create_domain_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainPost'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\Domain
     */
    public function subaccountDomainPost($create_domain_request, string $contentType = self::contentTypes['subaccountDomainPost'][0])
    {
        list($response) = $this->subaccountDomainPostWithHttpInfo($create_domain_request, $contentType);
        return $response;
    }

    /**
     * Operation subaccountDomainPostWithHttpInfo
     *
     * Create Domain
     *
     * @param  \sendpost\model\CreateDomainRequest $create_domain_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainPost'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\Domain, HTTP status code, HTTP response headers (array of strings)
     */
    public function subaccountDomainPostWithHttpInfo($create_domain_request, string $contentType = self::contentTypes['subaccountDomainPost'][0])
    {
        $request = $this->subaccountDomainPostRequest($create_domain_request, $contentType);
    ...
    /**
     * Operation subaccountDomainPostAsync
     *
     * Create Domain
     *
     * @param  \sendpost\model\CreateDomainRequest $create_domain_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountDomainPostAsync($create_domain_request, string $contentType = self::contentTypes['subaccountDomainPost'][0])
    {
        return $this->subaccountDomainPostAsyncWithHttpInfo($create_domain_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation subaccountDomainPostAsyncWithHttpInfo
     *
     * Create Domain
     *
     * @param  \sendpost\model\CreateDomainRequest $create_domain_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function subaccountDomainPostAsyncWithHttpInfo($create_domain_request, string $contentType = self::contentTypes['subaccountDomainPost'][0])
    {
        $returnType = '\sendpost\model\Domain';
        $request = $this->subaccountDomainPostRequest($create_domain_request, $contentType);
    ...
    /**
     * Create request for operation 'subaccountDomainPost'
     *
     * @param  \sendpost\model\CreateDomainRequest $create_domain_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['subaccountDomainPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function subaccountDomainPostRequest($create_domain_request, string $contentType = self::contentTypes['subaccountDomainPost'][0])
    {
        ...
        if ($create_domain_request === null || (is_array($create_domain_request) && count($create_domain_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_domain_request when calling subaccountDomainPost'
            );
        }
