...
class StatsApi
{
    ...
    /**
     * Operation accountSubaccountStatSubaccountIdAggregateGet
     *
     * Get Aggregate Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     * @param  \DateTime $to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn&#39;t ne more than 60 days ) (required)
     * @param  int $subaccount_id The ID of the subaccount to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountSubaccountStatSubaccountIdAggregateGet'] to see the possible values for this operation
     *
     ...
     */
    public function accountSubaccountStatSubaccountIdAggregateGet($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdAggregateGet'][0])
    {
        list($response) = $this->accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo($from, $to, $subaccount_id, $contentType);
        return $response;
    }

    /**
     * Operation accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo
     *
     * Get Aggregate Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     ...
     */
    public function accountSubaccountStatSubaccountIdAggregateGetWithHttpInfo($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdAggregateGet'][0])
    {
        $request = $this->accountSubaccountStatSubaccountIdAggregateGetRequest($from, $to, $subaccount_id, $contentType);
    ...
    /**
     * Operation accountSubaccountStatSubaccountIdAggregateGetAsync
     *
     * Get Aggregate Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     ...
     */
    public function accountSubaccountStatSubaccountIdAggregateGetAsync($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdAggregateGet'][0])
    {
        return $this->accountSubaccountStatSubaccountIdAggregateGetAsyncWithHttpInfo($from, $to, $subaccount_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountSubaccountStatSubaccountIdAggregateGetAsyncWithHttpInfo
     *
     * Get Aggregate Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountSubaccountStatSubaccountIdAggregateGetAsyncWithHttpInfo($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdAggregateGet'][0])
    {
    ...
    /**
     * Create request for operation 'accountSubaccountStatSubaccountIdAggregateGet'
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     * @param  \DateTime $to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn&#39;t ne more than 60 days ) (required)
     * @param  int $subaccount_id The ID of the subaccount to retrieve (required)
     ...
     */
    public function accountSubaccountStatSubaccountIdAggregateGetRequest($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdAggregateGet'][0])
    {

        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling accountSubaccountStatSubaccountIdAggregateGet'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling accountSubaccountStatSubaccountIdAggregateGet'
            );
        }
        ...
        if ($subaccount_id === null || (is_array($subaccount_id) && count($subaccount_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subaccount_id when calling accountSubaccountStatSubaccountIdAggregateGet'
            );
        }


        $resourcePath = '/account/subaccount/stat/{subaccount_id}/aggregate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation accountSubaccountStatSubaccountIdGet
     *
     * List Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     * @param  \DateTime $to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn&#39;t ne more than 60 days ) (required)
     * @param  int $subaccount_id The ID of the subaccount to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['accountSubaccountStatSubaccountIdGet'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\Stat[]
     */
    public function accountSubaccountStatSubaccountIdGet($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdGet'][0])
    {
        list($response) = $this->accountSubaccountStatSubaccountIdGetWithHttpInfo($from, $to, $subaccount_id, $contentType);
        return $response;
    }

    /**
     * Operation accountSubaccountStatSubaccountIdGetWithHttpInfo
     *
     * List Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     ...
     */
    public function accountSubaccountStatSubaccountIdGetWithHttpInfo($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdGet'][0])
    {
        $request = $this->accountSubaccountStatSubaccountIdGetRequest($from, $to, $subaccount_id, $contentType);
    ...
    /**
     * Operation accountSubaccountStatSubaccountIdGetAsync
     *
     * List Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountSubaccountStatSubaccountIdGetAsync($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdGet'][0])
    {
        return $this->accountSubaccountStatSubaccountIdGetAsyncWithHttpInfo($from, $to, $subaccount_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation accountSubaccountStatSubaccountIdGetAsyncWithHttpInfo
     *
     * List Stats
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountSubaccountStatSubaccountIdGetAsyncWithHttpInfo($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdGet'][0])
    {
    ...
    /**
     * Create request for operation 'accountSubaccountStatSubaccountIdGet'
     *
     * @param  \DateTime $from Start date for stats retrieval. (required)
     * @param  \DateTime $to Date to which stats should be retrieved ( Note than from date should be earlier than to date. Also the difference between from and to date shouldn&#39;t ne more than 60 days ) (required)
     * @param  int $subaccount_id The ID of the subaccount to retrieve (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function accountSubaccountStatSubaccountIdGetRequest($from, $to, $subaccount_id, string $contentType = self::contentTypes['accountSubaccountStatSubaccountIdGet'][0])
    {

        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling accountSubaccountStatSubaccountIdGet'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling accountSubaccountStatSubaccountIdGet'
            );
        }
        ...
        if ($subaccount_id === null || (is_array($subaccount_id) && count($subaccount_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subaccount_id when calling accountSubaccountStatSubaccountIdGet'
            );
        }


        $resourcePath = '/account/subaccount/stat/{subaccount_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getAggregateStatsByGroup
     *
     * Get Group Aggregate Stats
     *
     * @param  string $group Group whose aggregated stats need to be retrieved (required)
     * @param  \DateTime $from The starting date for the aggregated stats (required)
     * @param  \DateTime $to The ending date for the aggregated stats (Note: &#x60;from&#x60; should be earlier than &#x60;to&#x60; and the date range should not exceed 366 days) (required)
     * @param  int $subaccount_id The ID of the subaccount to retrieve (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAggregateStatsByGroup'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\AggregateStat
     */
    public function getAggregateStatsByGroup($group, $from, $to, $subaccount_id, string $contentType = self::contentTypes['getAggregateStatsByGroup'][0])
    {
        list($response) = $this->getAggregateStatsByGroupWithHttpInfo($group, $from, $to, $subaccount_id, $contentType);
        return $response;
    }

    /**
     * Operation getAggregateStatsByGroupWithHttpInfo
     *
     * Get Group Aggregate Stats
     *
     * @param  string $group Group whose aggregated stats need to be retrieved (required)
     ...
     * @return array of \sendpost\model\AggregateStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAggregateStatsByGroupWithHttpInfo($group, $from, $to, $subaccount_id, string $contentType = self::contentTypes['getAggregateStatsByGroup'][0])
    {
        $request = $this->getAggregateStatsByGroupRequest($group, $from, $to, $subaccount_id, $contentType);
    ...
    /**
     * Operation getAggregateStatsByGroupAsync
     *
     * Get Group Aggregate Stats
     *
     * @param  string $group Group whose aggregated stats need to be retrieved (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAggregateStatsByGroupAsync($group, $from, $to, $subaccount_id, string $contentType = self::contentTypes['getAggregateStatsByGroup'][0])
    {
        return $this->getAggregateStatsByGroupAsyncWithHttpInfo($group, $from, $to, $subaccount_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAggregateStatsByGroupAsyncWithHttpInfo
     *
     * Get Group Aggregate Stats
     *
     * @param  string $group Group whose aggregated stats need to be retrieved (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAggregateStatsByGroupAsyncWithHttpInfo($group, $from, $to, $subaccount_id, string $contentType = self::contentTypes['getAggregateStatsByGroup'][0])
    {
        $returnType = '\sendpost\model\AggregateStat';
        $request = $this->getAggregateStatsByGroupRequest($group, $from, $to, $subaccount_id, $contentType);
    ...
    /**
     * Create request for operation 'getAggregateStatsByGroup'
     *
     * @param  string $group Group whose aggregated stats need to be retrieved (required)
     * @param  \DateTime $from The starting date for the aggregated stats (required)
     * @param  \DateTime $to The ending date for the aggregated stats (Note: &#x60;from&#x60; should be earlier than &#x60;to&#x60; and the date range should not exceed 366 days) (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAggregateStatsByGroupRequest($group, $from, $to, $subaccount_id, string $contentType = self::contentTypes['getAggregateStatsByGroup'][0])
    {

        // verify the required parameter 'group' is set
        if ($group === null || (is_array($group) && count($group) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group when calling getAggregateStatsByGroup'
            );
        }
        ...
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getAggregateStatsByGroup'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getAggregateStatsByGroup'
            );
        }
        ...
        if ($subaccount_id === null || (is_array($subaccount_id) && count($subaccount_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subaccount_id when calling getAggregateStatsByGroup'
            );
        }


        $resourcePath = '/account/subaccount/stat/{subaccount_id}/group';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
