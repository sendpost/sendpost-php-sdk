...
class StatsAApi
{
    ...
    /**
     * Operation getAccountAggregateStats
     *
     * Get Account Aggregate Stats
     *
     * @param  \DateTime $from The start date for retrieving aggregated stats (inclusive) (required)
     * @param  \DateTime $to The end date for retrieving aggregated stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 366 days. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountAggregateStats'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\AggregateStats
     */
    public function getAccountAggregateStats($from, $to, string $contentType = self::contentTypes['getAccountAggregateStats'][0])
    {
        list($response) = $this->getAccountAggregateStatsWithHttpInfo($from, $to, $contentType);
        return $response;
    }

    /**
     * Operation getAccountAggregateStatsWithHttpInfo
     *
     * Get Account Aggregate Stats
     *
     * @param  \DateTime $from The start date for retrieving aggregated stats (inclusive) (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\AggregateStats, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountAggregateStatsWithHttpInfo($from, $to, string $contentType = self::contentTypes['getAccountAggregateStats'][0])
    {
        $request = $this->getAccountAggregateStatsRequest($from, $to, $contentType);
    ...
    /**
     * Operation getAccountAggregateStatsAsync
     *
     * Get Account Aggregate Stats
     *
     * @param  \DateTime $from The start date for retrieving aggregated stats (inclusive) (required)
     ...
     */
    public function getAccountAggregateStatsAsync($from, $to, string $contentType = self::contentTypes['getAccountAggregateStats'][0])
    {
        return $this->getAccountAggregateStatsAsyncWithHttpInfo($from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountAggregateStatsAsyncWithHttpInfo
     *
     * Get Account Aggregate Stats
     *
     * @param  \DateTime $from The start date for retrieving aggregated stats (inclusive) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountAggregateStatsAsyncWithHttpInfo($from, $to, string $contentType = self::contentTypes['getAccountAggregateStats'][0])
    {
        $returnType = '\sendpost\model\AggregateStats';
        $request = $this->getAccountAggregateStatsRequest($from, $to, $contentType);
    ...
    /**
     * Create request for operation 'getAccountAggregateStats'
     *
     * @param  \DateTime $from The start date for retrieving aggregated stats (inclusive) (required)
     * @param  \DateTime $to The end date for retrieving aggregated stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 366 days. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountAggregateStats'] to see the possible values for this operation
     ...
     */
    public function getAccountAggregateStatsRequest($from, $to, string $contentType = self::contentTypes['getAccountAggregateStats'][0])
    {

        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getAccountAggregateStats'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getAccountAggregateStats'
            );
        }
    ...
    /**
     * Operation getAccountAggregateStatsByGroup
     *
     * Get Account Group Aggregate Stats
     *
     * @param  string $group Group whose aggregate stats need to be retrieved. (required)
     * @param  \DateTime $from Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). (required)
     * @param  \DateTime $to Date to which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). Note that the difference between &#x60;from&#x60; and &#x60;to&#x60; should not be more than 366 days. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountAggregateStatsByGroup'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\AggregateStat
     */
    public function getAccountAggregateStatsByGroup($group, $from, $to, string $contentType = self::contentTypes['getAccountAggregateStatsByGroup'][0])
    {
        list($response) = $this->getAccountAggregateStatsByGroupWithHttpInfo($group, $from, $to, $contentType);
        return $response;
    }

    /**
     * Operation getAccountAggregateStatsByGroupWithHttpInfo
     *
     * Get Account Group Aggregate Stats
     *
     * @param  string $group Group whose aggregate stats need to be retrieved. (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\AggregateStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountAggregateStatsByGroupWithHttpInfo($group, $from, $to, string $contentType = self::contentTypes['getAccountAggregateStatsByGroup'][0])
    {
        $request = $this->getAccountAggregateStatsByGroupRequest($group, $from, $to, $contentType);
    ...
    /**
     * Operation getAccountAggregateStatsByGroupAsync
     *
     * Get Account Group Aggregate Stats
     *
     * @param  string $group Group whose aggregate stats need to be retrieved. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountAggregateStatsByGroupAsync($group, $from, $to, string $contentType = self::contentTypes['getAccountAggregateStatsByGroup'][0])
    {
        return $this->getAccountAggregateStatsByGroupAsyncWithHttpInfo($group, $from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountAggregateStatsByGroupAsyncWithHttpInfo
     *
     * Get Account Group Aggregate Stats
     *
     * @param  string $group Group whose aggregate stats need to be retrieved. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountAggregateStatsByGroupAsyncWithHttpInfo($group, $from, $to, string $contentType = self::contentTypes['getAccountAggregateStatsByGroup'][0])
    {
        $returnType = '\sendpost\model\AggregateStat';
        $request = $this->getAccountAggregateStatsByGroupRequest($group, $from, $to, $contentType);
    ...
    /**
     * Create request for operation 'getAccountAggregateStatsByGroup'
     *
     * @param  string $group Group whose aggregate stats need to be retrieved. (required)
     * @param  \DateTime $from Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). (required)
     * @param  \DateTime $to Date to which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). Note that the difference between &#x60;from&#x60; and &#x60;to&#x60; should not be more than 366 days. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAccountAggregateStatsByGroupRequest($group, $from, $to, string $contentType = self::contentTypes['getAccountAggregateStatsByGroup'][0])
    {

        // verify the required parameter 'group' is set
        if ($group === null || (is_array($group) && count($group) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group when calling getAccountAggregateStatsByGroup'
            );
        }
        ...
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getAccountAggregateStatsByGroup'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getAccountAggregateStatsByGroup'
            );
        }
    ...
    /**
     * Operation getAccountStatsByGroup
     *
     * List Account Group Stats
     *
     * @param  string $group Group whose stats need to be retrieved (required)
     * @param  \DateTime $from Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;) (required)
     * @param  \DateTime $to Date to which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). Note that the difference between &#x60;from&#x60; and &#x60;to&#x60; should not be more than 31 days. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAccountStatsByGroup'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\Stat[]
     */
    public function getAccountStatsByGroup($group, $from, $to, string $contentType = self::contentTypes['getAccountStatsByGroup'][0])
    {
        list($response) = $this->getAccountStatsByGroupWithHttpInfo($group, $from, $to, $contentType);
        return $response;
    }

    /**
     * Operation getAccountStatsByGroupWithHttpInfo
     *
     * List Account Group Stats
     *
     * @param  string $group Group whose stats need to be retrieved (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\Stat[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAccountStatsByGroupWithHttpInfo($group, $from, $to, string $contentType = self::contentTypes['getAccountStatsByGroup'][0])
    {
        $request = $this->getAccountStatsByGroupRequest($group, $from, $to, $contentType);
    ...
    /**
     * Operation getAccountStatsByGroupAsync
     *
     * List Account Group Stats
     *
     * @param  string $group Group whose stats need to be retrieved (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountStatsByGroupAsync($group, $from, $to, string $contentType = self::contentTypes['getAccountStatsByGroup'][0])
    {
        return $this->getAccountStatsByGroupAsyncWithHttpInfo($group, $from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountStatsByGroupAsyncWithHttpInfo
     *
     * List Account Group Stats
     *
     * @param  string $group Group whose stats need to be retrieved (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountStatsByGroupAsyncWithHttpInfo($group, $from, $to, string $contentType = self::contentTypes['getAccountStatsByGroup'][0])
    {
        $returnType = '\sendpost\model\Stat[]';
        $request = $this->getAccountStatsByGroupRequest($group, $from, $to, $contentType);
    ...
    /**
     * Create request for operation 'getAccountStatsByGroup'
     *
     * @param  string $group Group whose stats need to be retrieved (required)
     * @param  \DateTime $from Date from which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;) (required)
     * @param  \DateTime $to Date to which stats should be retrieved (should be in the format &#x60;YYYY-MM-DD&#x60;). Note that the difference between &#x60;from&#x60; and &#x60;to&#x60; should not be more than 31 days. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAccountStatsByGroupRequest($group, $from, $to, string $contentType = self::contentTypes['getAccountStatsByGroup'][0])
    {

        // verify the required parameter 'group' is set
        if ($group === null || (is_array($group) && count($group) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $group when calling getAccountStatsByGroup'
            );
        }
        ...
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getAccountStatsByGroup'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getAccountStatsByGroup'
            );
        }
    ...
    /**
     * Operation getAllAccountStats
     *
     * List Account Stats
     *
     * @param  \DateTime $from The start date for retrieving stats (inclusive) (required)
     * @param  \DateTime $to The end date for retrieving stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 31 days. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllAccountStats'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\AccountStats[]
     */
    public function getAllAccountStats($from, $to, string $contentType = self::contentTypes['getAllAccountStats'][0])
    {
        list($response) = $this->getAllAccountStatsWithHttpInfo($from, $to, $contentType);
        return $response;
    }

    /**
     * Operation getAllAccountStatsWithHttpInfo
     *
     * List Account Stats
     *
     * @param  \DateTime $from The start date for retrieving stats (inclusive) (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\AccountStats[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllAccountStatsWithHttpInfo($from, $to, string $contentType = self::contentTypes['getAllAccountStats'][0])
    {
        $request = $this->getAllAccountStatsRequest($from, $to, $contentType);
    ...
    /**
     * Operation getAllAccountStatsAsync
     *
     * List Account Stats
     *
     * @param  \DateTime $from The start date for retrieving stats (inclusive) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAccountStatsAsync($from, $to, string $contentType = self::contentTypes['getAllAccountStats'][0])
    {
        return $this->getAllAccountStatsAsyncWithHttpInfo($from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllAccountStatsAsyncWithHttpInfo
     *
     * List Account Stats
     *
     * @param  \DateTime $from The start date for retrieving stats (inclusive) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAccountStatsAsyncWithHttpInfo($from, $to, string $contentType = self::contentTypes['getAllAccountStats'][0])
    {
        $returnType = '\sendpost\model\AccountStats[]';
        $request = $this->getAllAccountStatsRequest($from, $to, $contentType);
    ...
    /**
     * Create request for operation 'getAllAccountStats'
     *
     * @param  \DateTime $from The start date for retrieving stats (inclusive) (required)
     * @param  \DateTime $to The end date for retrieving stats (inclusive). The difference between &#x60;from&#x60; and &#x60;to&#x60; should not exceed 31 days. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllAccountStats'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllAccountStatsRequest($from, $to, string $contentType = self::contentTypes['getAllAccountStats'][0])
    {

        // verify the required parameter 'from' is set
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling getAllAccountStats'
            );
        }
        ...
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling getAllAccountStats'
            );
        }
