...
class WebhookApi
{
     ...
     * Delete Webhook
     *
     * @param  int $webhook_id ID of the webhook to delete. (required)
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \sendpost\model\DeleteWebhookResponse
     */
     ...
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \sendpost\model\DeleteWebhookResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteWebhookWithHttpInfo($webhook_id, string $contentType = self::contentTypes['deleteWebhook'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\sendpost\model\DeleteWebhookResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\sendpost\model\DeleteWebhookResponse';
        $request = $this->deleteWebhookRequest($webhook_id, $contentType);
    ...
    public function deleteWebhookRequest($webhook_id, string $contentType = self::contentTypes['deleteWebhook'][0])
    {
        ...
        $resourcePath = '/account/webhook/{webhook_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string|null $search Case insensitive search against webhook URL. (optional)
     ...
     * @return \sendpost\model\Webhook[]
     */
    public function getAllWebhooks($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        list($response) = $this->getAllWebhooksWithHttpInfo($limit, $offset, $search, $contentType);
        return $response;
    }
     ...
     * @return array of \sendpost\model\Webhook[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWebhooksWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        $request = $this->getAllWebhooksRequest($limit, $offset, $search, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        return $this->getAllWebhooksAsyncWithHttpInfo($limit, $offset, $search, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        $returnType = '\sendpost\model\Webhook[]';
        $request = $this->getAllWebhooksRequest($limit, $offset, $search, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllWebhooksRequest($limit = null, $offset = null, $search = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
     ...
     * Get Webhook
     *
     * @param  int $webhook_id The ID of the webhook to retrieve. (required)
     ...
     * Update Webhook
     *
     * @param  \sendpost\model\UpdateWebhook $update_webhook update_webhook (required)
     * @param  int $webhook_id ID of the webhook to update. (required)
     ...
     * @return \sendpost\model\Webhook
     */
    public function updateWebhook($update_webhook, $webhook_id, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        list($response) = $this->updateWebhookWithHttpInfo($update_webhook, $webhook_id, $contentType);
        return $response;
    }
     ...
     * Update Webhook
     *
     * @param  \sendpost\model\UpdateWebhook $update_webhook (required)
     * @param  int $webhook_id ID of the webhook to update. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWebhook'] to see the possible values for this operation
     *
     * @throws \sendpost\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return array of \sendpost\model\Webhook, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWebhookWithHttpInfo($update_webhook, $webhook_id, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        $request = $this->updateWebhookRequest($update_webhook, $webhook_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsync($update_webhook, $webhook_id, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        return $this->updateWebhookAsyncWithHttpInfo($update_webhook, $webhook_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsyncWithHttpInfo($update_webhook, $webhook_id, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        $returnType = '\sendpost\model\Webhook';
        $request = $this->updateWebhookRequest($update_webhook, $webhook_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWebhookRequest($update_webhook, $webhook_id, string $contentType = self::contentTypes['updateWebhook'][0])
    {
